...
The MAPS data model exists within a single schema, visualised below. For more detail on table and field purposes, please see the table, view and field descriptions in the generated entities.

![MAPS Entity Relationship Diagram](images/MAPS_ER_diagram.png)
